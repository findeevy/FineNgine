...
void FineNgine::populateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& createInfo){
  createInfo = {};
...
VKAPI_ATTR VkBool32 VKAPI_CALL FineNgine::debugCallback( VkDebugUtilsMessageSeverityFlagBitsEXT /*messageSeverity*/, VkDebugUtilsMessageTypeFlagsEXT /*messageType*/, const VkDebugUtilsMessengerCallbackDataEXT* pCallbackData, void* /*pUserData*/){
...
SwapChainSupportDetails FineNgine::querySwapChainSupport(VkPhysicalDevice device){
...
void FineNgine::framebufferResizeCallback(GLFWwindow* window, int /*width*/, int /*height*/){
...
VkFormat FineNgine::findSupportedFormat(const std::vector<VkFormat>& candidates, VkImageTiling tiling, VkFormatFeatureFlags features){
...
void FineNgine::generateMipmaps(VkImage image, VkFormat imageFormat, int32_t texWidth, int32_t texHeight, uint32_t mipLevels) {
...
void FineNgine::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex){
...
VkSurfaceFormatKHR FineNgine::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats){
...
VkPresentModeKHR FineNgine::chooseSwapPresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes){
...
VkExtent2D FineNgine::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities){
...
VkImageView FineNgine::createImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags, uint32_t mipLevels){
