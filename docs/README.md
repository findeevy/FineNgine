...
## Compilation:
Run the makefile after installing the [dependencies](#dependencies). Also make sure to compile the shaders using the provided script [https://github.com/findeevy/Finengine/blob/main/compileShaders.sh](compileShaders.sh). Must have GCC (or other C++ compiler, although I have not tested any others).
